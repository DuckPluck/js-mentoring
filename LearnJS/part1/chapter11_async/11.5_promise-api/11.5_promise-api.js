 ...
 *                                          Его результат - результат первого УСПЕШНОГО промиса (ошибки кладёт в объект ошибок)
...
// - Если все промисы будут отклонены, `.catch()` вернет объект AggregateError, содержащий в св-ве `errors` массив всех ошибок
